...
export default function CCGenerator() {
  ...
  return (
    <>
      <SEO
        title="Multi BIN CC Generator | Generate Test Credit Card Numbers"
        description="Generate test credit card numbers for multiple BINs. A tool for developers and testers to create valid card numbers for various payment scenarios."
        canonical="https://example.com/cc-generator"
      />
      <div className="min-h-screen bg-black text-white p-4 md:p-8">
        <div className="max-w-3xl mx-auto space-y-8">
          <h1 className="text-2xl md:text-4xl font-bold text-center flex items-center justify-center gap-2">
            <CreditCard className="w-8 h-8 text-[#7fff00]" aria-hidden="true" />
            <span>MULTI BIN CC GENERATOR</span>
          </h1>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="space-y-2">
                <label htmlFor="bins" className="text-[#7fff00] font-bold">
                  Bins
                </label>
                <Input
                  id="bins"
                  ...
                  aria-describedby="bins-description"
                />
                <p id="bins-description" className="text-sm text-gray-400">
                  * Separate your bins with ;
                </p>
              </div>
              ...
              <div className="space-y-2">
                <label htmlFor="cvv" className="text-[#7fff00] font-bold">
                  CVV
                </label>
                <Input
                  id="cvv"
                ...
                />
                <p id="cvv-description" className="text-sm text-gray-400">
                  * Leave blank for random CVV
                </p>
              </div>

              <div className="space-y-2">
                <label htmlFor="quantity" className="text-[#7fff00] font-bold">
                  Quantity
                </label>
                <Input
                  id="quantity"
            ...
            <div className="space-y-4">
              <Textarea
                ...
                aria-label="Generated credit card numbers"
              />
              <div className="flex flex-wrap gap-2" aria-label="Generated card types">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Badge variant="outline" className="text-[#7fff00] cursor-pointer">
                          ...
                          <Info className="w-3 h-3 ml-1" aria-hidden="true" />
                        </Badge>
                      </TooltipTrigger>
                      <TooltipContent>
